...
class SupportToSupportEntityConverterTest
{
    ...
    private SupportToSupportEntityConverter subject;

    @BeforeEach
    void beforeEach()
    {
        subject = new SupportToSupportEntityConverter();
    }

    @Test
    void itConverts()
    {
        final var source = Support.builder()
                .id(ID)
                .subject(SUBJECT)
                .username(USER_NAME)
        ...
        final var expected = SupportEntity.builder()
                .id(ID)
                .subject(SUBJECT)
                .username(USER_NAME)
                .userEmail(USER_EMAIL)
